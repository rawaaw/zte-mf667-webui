...
//alert("simulation called");
	...
	"data_volume_limit_size","data_volume_alert_percent","data_volume_limit_unit","roam_setting_option","upg_roam_switch","hplmn","mdm_mcc","mdm_mnc"];
    ...
    function timerUpdateStatus(data) {
        ...
        timerInfo.mdmMcc = data.mdm_mcc;
        timerInfo.mdmMnc = data.mdm_mnc;
//alert(data.mdm_mnc);
...
//        }
    ...
    function getClass0SMSMessages(){
        ...
        function prepare(params, isPost) {
            var obj = {
                ...
                cmd : "sms_data_class0",
                page : params.page,
                data_per_page: params.data_per_page
            };
            return obj;
        }
	...
	function saveClass0SMS(){
		...
		function prepare(params, isPost){
			var obj = {
				...
				goformId : "SAVE_SMS",
				SMSMessage : escapeMessage(encodeMessage(params.message)), //短信内容
				SMSNumber : params.numbers,//短消息号码
				Index : params.index,//-1表示新建后保存；否则，表示编辑后保存，要传递实际的ID
				encode_type : getEncodeType(params.message).encodeType,
				sms_time : params.currentTimeString,
				location : 1,
	...
	return {
        ...
        getClass0SMSMessages : getClass0SMSMessages,//Test Done
